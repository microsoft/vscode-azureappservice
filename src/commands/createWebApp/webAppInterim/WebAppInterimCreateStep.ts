...
import { DomainNameLabelScope, type SiteInterim } from './webAppInterimTypes';

export class WebAppInterimCreateStep extends AzureWizardExecuteStep<IWebAppWizardContext> {
    ...
    private async getNewSite(context: IWebAppWizardContext): Promise<SiteInterim> {
        ...
        const site: SiteInterim = {
            ...
            properties: {
                autoGeneratedDomainNameLabelScope: DomainNameLabelScope.Tenant,
