...
export async function promptToSaveDeployDefaults(node: SiteTreeItem, workspacePath: string, deployPath: string): Promise<void> {
    return await callWithTelemetryAndErrorHandling('promptToSaveDeployDefaults', async (context: IActionContext): Promise<void> => {
