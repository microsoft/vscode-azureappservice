...
## 0.18.0 - 2020-07-10
### Added
- Added support for Free App Service Trial Apps! Visit [here](https://code.visualstudio.com/tryappservice/?utm_source=appservice-extension) to Create and Import your own Free Node.js Trial App.
